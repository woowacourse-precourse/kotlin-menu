...
- 예외 사항 처리
  - 코치이름이 2글자 미만 4글자 초과일 경우
  - 코치 이름이 2명 미만,  5명 초과일 경우
  - 코치 이름이 중복된 경우
...
- 예외 사항 처리
  - 먹지 못하는 음식을 2개 초과하여 작성할 경우
  - 음식 이름이 중복된 경우


### 한 주에 카테고리는 최대 2개까지만 중복 가능하다

### 각 코치에게 한 주에 중복되지 않는 메뉴를 추천해준다.

- 만약 중복된다면 다시 메뉴추천리스트를 만든다.
