...
class InputView {
    ...
    fun inputCoachNotEat(coaches: List<String>): Map<String, List<String>> {
        val coachesNotEatFoods = mutableMapOf<String, List<String>>()
        for (c in coaches) {
            ...
            coachesNotEatFoods[c] = userInput.split(',')
        }
        return coachesNotEatFoods.toMap()
    }
