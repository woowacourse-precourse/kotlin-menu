...
class InputValidator(val userInput: String) {
    enum class ErrorMessage(val sentence: String) {
        LENGTH_ERROR("이름은 최소 2글자 이상 최대 4글자까지 입력할 수 있습니다."),
        NAME_SIZE_ERROR("최소 2명, 최대 5명까지 입력할 수 있습니다."),
        MENU_SIZE_ERROR("먹지 못하는 메뉴는 최대 2개 까지 입력할 수 있습니다."),
        OVERLAP_ERROR("코치 이름은 중복될 수 없습니다.")
    }
